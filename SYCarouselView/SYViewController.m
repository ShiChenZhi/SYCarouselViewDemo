...
//  SYCarouselViewDemo
//
//  Created by 施忆 on 16/3/17.
//  Copyright © 2016年 施忆. All rights reserved.
//

#import "SYViewController.h"
#import "SYCarouselView.h"

@interface SYViewController () <SYCarouselViewDelegate>

@property (nonatomic, strong) SYCarouselView *carouselView;
@property (weak, nonatomic) IBOutlet SYCarouselView *carouselView1;
@end
...
- (void)viewDidLoad {
    ...
    //arr3的使用
    self.carouselView = [SYCarouselView carouselViewWithImageArray:arr3 describeArray:describeArray];
...
- (void)carouselView:(SYCarouselView *)carouselView clickImageAtIndex:(NSInteger)index {
    NSLog(@"点击了第%ld张图片", index);
}
